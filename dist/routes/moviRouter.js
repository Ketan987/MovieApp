...
function getRouter() {
    ...
    router
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, movieController_1.QuerySearch(req, res)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    router
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, movieController_1.getpageMovies(req, res)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    router
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("yes");
                    return [4 /*yield*/, movieController_1.IdSearch(req, res)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
